  ...
  return (
    <section id="faq" data-section-light className="bg-bone py-section-y">
      <div className="mx-auto max-w-shell px-gutter">
        <SectionLabel num="10" label="Before you ask" />
          ...
          {FAQS.map((faq, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Always rendered, only collapsed. The design ships every
                    answer in the markup, and FAQ copy that never reaches the
                    HTML cannot be indexed by search engines. */}
                <motion.div
                  id={`faq-answer-${i}`}
                  role="region"
                  initial={false}
